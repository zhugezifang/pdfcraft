    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="py-6 border-t border-[hsl(var(--color-border))]">
          ...
          <AdsterraAd adId="ecb2cd420ef4bb991c56a3f5061b33e7" />

          <iframe src="https://www.pdf24tools.online/adsterra" style={{ width: '100%'}} className="mb-4"/>
        ...
        <div className="pt-8 border-t border-[hsl(var(--color-border))] flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="https://www.10015tools.online/zh" target="_blank"  className="text-xs text-[hsl(var(--color-muted-foreground))] hover:text-[hsl(var(--color-foreground))]">免费在线工具箱</Link>
