 ...
 * 
 * 中文工具内容 - 包含所有67個PDF工具的详细描述、使用說明、用例和常见问题
 */
...
export const toolContentZhTw: Record<string, ToolContent> = {
  ...
  'pdf-multi-tool': {
    ...
    description: `
      <p>PDF多功能工具是您处理所有PDF页面管理任务的综合解决方案。這款强大的一站式工具将多种PDF操作整合到一個直观的界面中，为您节省時间和精力。</p>
      <p>无论您需要合并多個文档、将大型PDF拆分成小文件、重新整理页面、删除不需要的内容、旋转页面還是提取特定部分，這個工具都能轻松处理，无需在不同应用程序之间切换。</p>
      <p>所有处理都直接在您的浏览器中完成，确保您的文档保持私密和安全。不會将任何文件上传到服务器。</p>
    `,
    howToUse: [
    ...
    useCases: [
      { title: '文档准备', description: '通過删除不必要的页面、重新排序内容和合并多個文件来准备提交文档。', icon: 'file-check' },
      { title: '报告汇编', description: '合并多個报告部分，添加封面页，将章节整理成一個专业文档。', icon: 'book-open' },
      { title: '档案管理', description: '将大型档案文件拆分成可管理的部分，提取相关页面，重新整理历史文档。', icon: 'archive' },
    ],
    faq: [
      { question: '一次可以处理多少個PDF？', answer: '您可以同時上传和处理最多10個PDF文件，合并最大大小为500MB。' },
      { question: '书签會被保留吗？', answer: '是的，合并PDF時，工具會保留现有书签，并可选择将它们合并成统一的书签结构。' },
      { question: '有页数限制吗？', answer: '没有严格的页数限制。该工具可以处理数百页的文档，但非常大的文件可能需要更长的处理時间。' },
    ],
  },

  'merge-pdf': {
    title: '合并PDF',
    metaDescription: '将多個PDF文件合并成一個文档。免费在线PDF合并器，支持拖放重新排序。',
    keywords: ['合并pdf', '组合pdf', '连接pdf', 'pdf合并器', '拼接pdf'],
    description: `
      <p>合并PDF允许您快速轻松地将多個PDF文档合并成一個文件。无论您是整合报告、合并扫描文档還是组装演示文稿，這個工具都能使過程变得无缝。</p>
      <p>只需上传文件，使用拖放功能按所需顺序排列，然后将它们合并成一個连贯的文档。该工具保留原始文件的质量，并可选择保留每個源文档的书签。</p>
      <p>所有合并操作都在您的浏览器本地进行，确保敏感文档的完全隐私。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '将多個PDF文件拖放到上传区域，或点击从设备中选择文件。' },
      { step: 2, title: '排列顺序', description: '拖放文件缩略图以按所需顺序排列。' },
      { step: 3, title: '合并并下载', description: '点击合并按钮组合所有文件，然后下载合并后的PDF。' },
    ],
    useCases: [
      { title: '合并报告', description: '将月度或季度报告合并成一個年度文档，便于分发和存档。', icon: 'file-text' },
      { title: '组装作品集', description: '将多個项目文档、证书或工作样本合并成专业作品集。', icon: 'briefcase' },
      { title: '整合发票', description: '将多张发票或收据合并成一個文档，用于會計和记录保存。', icon: 'receipt' },
    ],
    faq: [
      { question: '可以合并多少個PDF？', answer: '您可以一次合并最多100個PDF文件，总大小最高可达500MB。' },
      { question: '合并后的PDF會保持原始质量吗？', answer: '是的，合并過程保留所有文档的原始质量，不會进行任何压缩或质量损失。' },
  ...
  'rotate-custom': {
    ...
    description: `
      ...
      <p>非常适合校正扫描時稍微倾斜的文档，或将图表和图纸调整到正确的方向。您可以校正單個页面或对整個文档应用相同的旋转。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档在實現完美对齐的同時保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '上传包含需要旋转页面的PDF文件。' },
      { step: 2, title: '设置旋转角度', description: '为每個页面输入精确的旋转度数，或为所有页面设置批量角度。' },
      { step: 3, title: '预览和调整', description: '使用實時预览确保页面完美对齐。' },
      { step: 4, title: '应用并下载', description: '点击旋转应用更改并下载校正后的PDF。' },
    ],
    useCases: [
      { title: '扫描文档', description: '校正扫描時进纸倾斜的页面。', icon: 'scan' },
      { title: '技术图纸', description: '精确调整技术图表和平面图的方向。', icon: 'ruler' },
      { title: '创意排版', description: '通過将页面旋转到特定艺术角度来创建独特的布局。', icon: 'pen-tool' },
    ],
    faq: [
      { question: '可以按小数旋转吗，例如45.5度？', answer: '目前工具支持整数度数，但我们正在努力启用小数精度。' },
      { question: '這會影响页面内容吗？', answer: '内容會被视觉旋转。页面大小會自动调整以适应旋转后的内容。' },
      { question: '可以只旋转一個页面吗？', answer: '是的，您可以为任何單個页面设置自定义旋转角度，同時保持其他页面不变。' },
    ],
  },

  'grid-combine': {
    title: '网格组合 PDF',
    metaDescription: '将多個PDF文件组合到單页面上的灵活网格布局中。每页排列2、4、6、9個或更多PDF，支持边框和间距。',
    keywords: ['网格组合', '合并pdf网格', 'pdf拼贴', '多pdf一页', 'pdf n-up', '组合pdf网格'],
    description: `
      <p>网格组合工具提供了一种将多個独立的PDF文件合并到單页面上的独特方式。与简單追加页面的标准“合并PDF”工具或重新排列單個文档页面的“N-Up”工具不同，网格组合获取多個输入文件并将它们并排排列在可自定义的网格布局中。</p>
      <p>您可以选择各种网格配置，如2x1、2x2、3x3等。這非常适合比较多個文档、从不同来源创建讲义或打印多個文件的紧凑版本。</p>
      <p>通過控制页面大小、方向、边距、间距和边框来自定义输出。所有处理都在您的浏览器本地进行，以實現最大的隐私保护。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '上传两個或更多您想要组合的PDF文件。您可以按所需顺序重新排列它们。' },
      { step: 2, title: '选择网格布局', description: '选择您想要的网格布局（例如，2x2表示每页4個文件，3x3表示每页9個文件）。' },
    ...
    useCases: [
      { title: '视觉比较', description: '将设计或文档的不同版本并排放置在單個页面上以便于比较。', icon: 'layout-grid' },
      { title: '打印讲义', description: '将多個短文档或幻灯片合并到單张纸上以节省打印成本。', icon: 'printer' },
      { title: '作品集创建', description: '在清晰、有组织的网格概览中展示多個项目文件。', icon: 'image' },
    ],
    faq: [
      { question: '這与N-Up有什么不同？', answer: 'N-Up从一個PDF中获取页面并将它们放在一张纸上。网格组合获取多個不同的PDF文件并将它们放在一张纸上。' },
      { question: '我可以组合多少個文件？', answer: '您可以根据浏览器内存组合多达100個文件，但像4x4這样的布局每页最多可容纳16個文件。' },
      { question: '我可以添加边框吗？', answer: '是的，您可以在每個PDF文件周围添加边框并自定义边框颜色。' },
    ],
  },

  'split-pdf': {
    title: '拆分PDF',
    metaDescription: '将PDF文件拆分成多個文档。提取特定页面或按页面范围分割。',
    keywords: ['拆分pdf', '分割pdf', '分离pdf', '提取页面', 'pdf拆分器'],
    description: `
      <p>拆分PDF使您能够将單個PDF文档分成多個较小的文件。這非常适合提取特定章节、分离合并的文档或从多页PDF创建單独的文件。</p>
      <p>您可以按特定页面范围拆分、提取單個页面或按固定间隔分割文档。该工具提供页面的可视预览，使您能够轻松选择所需的内容。</p>
    ...
    howToUse: [
      ...
      { step: 4, title: '拆分并下载', description: '点击拆分创建新的PDF文件，單独下载或作为ZIP压缩包下载。' },
    ],
    useCases: [
      { title: '提取章节', description: '将书籍或手册拆分成單独的章节，便于阅读或分发。', icon: 'book' },
      { title: '分离合并扫描', description: '将批量扫描的文档分成每個原始文档的單独文件。', icon: 'copy' },
      { title: '创建讲义', description: '从演示文稿中提取特定幻灯片或页面以创建重点讲义。', icon: 'presentation' },
    ],
    faq: [
      { question: '可以将PDF拆分成單独的页面吗？', answer: '是的，您可以通過选择"每页拆分"选项将PDF拆分成單独的單页文件。' },
      { question: '拆分時书签會怎样？', answer: '落在提取页面范围内的书签會保留在生成的PDF文件中。' },
  ...
  'compress-pdf': {
    title: '压缩PDF',
    metaDescription: '减小PDF文件大小同時保持质量。免费在线PDF压缩器，生成更小的文件。',
    keywords: ['压缩pdf', '减小pdf大小', 'pdf压缩器', '缩小pdf', '优化pdf'],
    description: `
      <p>压缩PDF在保持可接受质量的同時减小PDF文档的文件大小。這对于电子邮件附件、网络上传或节省存储空间至关重要。</p>
      <p>该工具提供多种压缩级别，以平衡文件大小减少和质量保持。您可以选择激进压缩以获得最大的大小减少，或选择轻度压缩以保持更高的质量。</p>
      <p>所有压缩都在您的浏览器中进行，确保您的文档永远不會离开您的设备。</p>
    `,
    howToUse: [
    ...
    useCases: [
      ...
      { title: '网络发布', description: '优化PDF以供网络下载，提高页面加载時间和用户体验。', icon: 'globe' },
      { title: '存储优化', description: '压缩存档文档以节省磁盘空间同時保持可访问性。', icon: 'hard-drive' },
    ],
    faq: [
      { question: '可以减少多少文件大小？', answer: '压缩结果因PDF内容而异。图像密集的PDF通常可以减少50-80%，而纯文本PDF可能减少较少。' },
      { question: '压缩會影响文本质量吗？', answer: '文本在所有压缩级别下都保持清晰可读。只有图像和图形會受到压缩影响。' },
      { question: '可以一次压缩多個PDF吗？', answer: '是的，您可以同時上传和压缩最多10個PDF文件。' },
    ],
  },
  ...
  'edit-pdf': {
    ...
    useCases: [
      { title: '文档审阅', description: '为协作审阅過程添加评论、高亮和标记到文档。', icon: 'message-square' },
      { title: '表單填写', description: '填写文本字段、添加签名并完成PDF表單，无需打印。', icon: 'edit-3' },
    ...
    faq: [
      ...
      { question: '可以撤销更改吗？', answer: '是的，编辑器支持撤销/重做功能。您也可以在保存前随時重置为原始文档。' },
    ],
  },

  'jpg-to-pdf': {
    title: 'JPG转PDF',
    metaDescription: '将JPG图像转换为PDF。将多個JPG文件合并成一個PDF文档。',
    keywords: ['jpg转pdf', 'jpeg转pdf', '转换jpg', '图像转pdf', '照片转pdf'],
    description: `
      <p>JPG转PDF可以快速轻松地将您的JPEG图像转换为PDF文档。无论您有單张照片還是多张图像，這個工具都能创建专业外观的PDF文件。</p>
      <p>您可以将多個JPG文件合并成一個PDF，按任意顺序排列，并自定义页面大小和方向。转换過程保留图像质量，同時创建紧凑、可共享的PDF文件。</p>
      <p>所有转换都在您的浏览器中进行，确保您的照片保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传JPG图像', description: '拖放您的JPG文件或点击从设备中选择图像。' },
      { step: 2, title: '排列和配置', description: '通過拖动重新排序图像，选择页面大小和方向选项。' },
    ...
    faq: [
      { question: '可以转换多少张图像？', answer: '您可以将最多100张JPG图像转换成一個PDF文档。' },
      { question: '图像质量會保留吗？', answer: '是的，图像以原始质量嵌入。您可以选择压缩它们以减小文件大小。' },
      { question: '可以为不同图像设置不同的页面大小吗？', answer: '该工具对所有页面应用统一的页面大小。每张图像都會缩放以适应所选页面大小，同時保持纵横比。' },
    ],
  },
  ...
  'sign-pdf': {
    ...
    description: `
      <p>签署PDF允许您快速安全地为PDF文档添加电子签名。通過绘制、输入或上传图像创建您的签名，然后将其放置在文档的任何位置。</p>
      <p>您可以在單個文档中添加多個签名，精确调整大小和位置，并保存签名以供将来使用。该工具非常适合合同、协议、表單和任何需要签名的文档。</p>
    ...
    useCases: [
      ...
      { title: '表單填写', description: '为申请表、同意书和官方文档添加签名。', icon: 'clipboard' },
    ...
    faq: [
      ...
      { question: '可以保存签名以供将来使用吗？', answer: '是的，您可以将签名保存到浏览器的本地存储中，以便在签署未来文档時快速访问。' },
      { question: '可以在一個文档中添加多個签名吗？', answer: '是的，您可以添加任意数量的签名，在任何页面上独立定位每個签名。' },
    ],
  },
  ...
  'crop-pdf': {
    ...
    description: `
      <p>裁剪PDF允许您修剪边距并从PDF页面中删除不需要的区域。這对于删除多余的空白、聚焦特定内容区域或标准化页面尺寸非常有用。</p>
      <p>您可以统一裁剪所有页面或單独调整每個页面。可视界面准确显示将保留的内容，使您能够轻松获得精确的结果。</p>
    ...
    useCases: [
      { title: '删除边距', description: '修剪扫描文档或具有大边框的PDF的過多边距。', icon: 'maximize-2' },
      { title: '聚焦内容', description: '裁剪以突出特定内容区域，删除页眉、页脚或侧边栏。', icon: 'target' },
      { title: '标准化页面', description: '通過裁剪到统一尺寸使所有页面大小相同。', icon: 'square' },
    ],
    faq: [
      { question: '裁剪會永久删除内容吗？', answer: '是的，裁剪會删除裁剪区域外的内容。请确保保留原始文件的备份。' },
      { question: '可以对不同页面进行不同的裁剪吗？', answer: '是的，您可以对單個页面或页面组应用不同的裁剪设置。' },
      { question: '裁剪會影响文本质量吗？', answer: '不會，裁剪只删除裁剪边界外的区域。剩余内容保持原始质量。' },
    ],
  },

  'extract-pages': {
    title: '提取页面',
    metaDescription: '从PDF文件中提取特定页面。选择并保存單個页面为新文档。',
    keywords: ['提取pdf页面', '保存pdf页面', '复制pdf页面', 'pdf页面提取器'],
    description: `
      <p>提取页面允许您从PDF文档中选择并保存特定页面为新文件。這非常适合提取相关部分、创建摘录或分离合并的文档。</p>
      <p>您可以提取單個页面、页面范围或多個不连续的页面。可视页面预览使您能够轻松识别和选择所需的页面。</p>
    ...
    useCases: [
      ...
      { title: '分享特定内容', description: '提取特定页面进行分享，无需发送整個文档。', icon: 'share-2' },
      { title: '存档重要页面', description: '提取并保存文档中的关键页面以供长期存档。', icon: 'archive' },
    ],
    faq: [
      { question: '可以提取不连续的页面吗？', answer: '是的，您可以选择任意页面组合，无论是连续的還是分散在整個文档中的。' },
      { question: '书签會保留吗？', answer: '指向提取页面的书签會保留在新文档中。' },
      { question: '可以从多個PDF中提取页面吗？', answer: '此工具一次处理一個PDF。要合并来自多個PDF的页面，请使用合并PDF工具。' },
    ],
  },
  ...
  'organize-pdf': {
    ...
    howToUse: [
      ...
      { step: 2, title: '重新排列页面', description: '拖动页面缩略图重新排序。根据需要点击每個页面上的复制或删除按钮。' },
    ...
    faq: [
      ...
      { question: '有撤销功能吗？', answer: '是的，您可以撤销和重做更改。您也可以随時重置为原始顺序。' },
      { question: '可以同時整理多個PDF吗？', answer: '此工具一次处理一個PDF。要合并和整理多個PDF，请先使用合并PDF工具合并它们。' },
    ],
  },
  ...
  'delete-pages': {
    ...
    description: `
      <p>删除页面允许您快速轻松地从PDF文档中删除不需要的页面。无论您需要删除空白页、過時内容還是敏感信息，這個工具都能简化操作。</p>
      <p>可视页面缩略图帮助您准确识别要删除的页面。您可以删除單個页面或一次删除多個页面。</p>
    ...
    useCases: [
      { title: '删除空白页', description: '通過删除意外包含的空白页来清理文档。', icon: 'file-x' },
      { title: '删除敏感内容', description: '在共享文档前删除包含机密信息的页面。', icon: 'shield' },
      { title: '精简文档', description: '删除過時或不相关的页面以创建更集中的文档。', icon: 'filter' },
    ],
    faq: [
      { question: '可以恢复已删除的页面吗？', answer: '删除在输出文件中是永久的。如果以后可能需要這些页面，请保留原始文档的备份。' },
      { question: '可以一次删除多個页面吗？', answer: '是的，您可以同時选择和删除多個页面。' },
      { question: '删除页面會影响书签吗？', answer: '指向已删除页面的书签将被移除。指向剩余页面的书签會保留。' },
    ],
  },
  ...
  'bookmark': {
    ...
    description: `
      ...
      <p>您可以添加新书签、编辑现有书签、重新整理书签层次结构或从外部来源导入书签。這個工具对于创建专业、可导航的文档至关重要。</p>
  ...
  'table-of-contents': {
    ...
    faq: [
      ...
      { question: '目录条目可以点击吗？', answer: '是的，每個条目都是可点击的链接，导航到相应的页面。' },
    ],
  },
  ...
  'page-numbers': {
    ...
    description: `
      ...
      <p>您可以设置起始编号、跳過某些页面并使用不同的编号格式（1, 2, 3 或 i, ii, iii）。非常适合创建具有正确分页的专业文档。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择文档。' },
    ...
    faq: [
      { question: '可以跳過第一页吗？', answer: '是的，您可以指定要编号的页面和要跳過的页面，如标题页或封面页。' },
  ...
  'header-footer': {
    ...
    faq: [
      ...
      { question: '可以在某些页面上跳過页眉/页脚吗？', answer: '是的，您可以指定哪些页面应该有页眉/页脚，哪些应该跳過。' },
    ],
  },
  ...
  'invert-colors': {
    ...
    description: `
      <p>反转颜色可以反转PDF文档中的颜色，创建负片图像效果。這对于创建文档的暗模式版本特别有用，便于在低光条件下阅读。</p>
      <p>该工具可以反转所有颜色或选择性地保留某些元素（如图像）。非常适合在夜间阅读文档時减少眼睛疲劳。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择文档。' },
      { step: 2, title: '配置选项', description: '选择是反转所有内容還是保留图像。' },
      { step: 3, title: '反转并下载', description: '点击反转处理文档并下载结果。' },
    ],
    useCases: [
      { title: '夜间阅读', description: '创建文档的暗模式版本，便于夜间舒适阅读。', icon: 'moon' },
      { title: '减少眼睛疲劳', description: '反转明亮的文档以减少长時间阅读時的眼睛疲劳。', icon: 'eye' },
      { title: '节省打印', description: '反转文档以减少打印草稿時的墨水使用。', icon: 'printer' },
    ],
    faq: [
      { question: '图像也會被反转吗？', answer: '默认情况下會。您可以选择在反转文本和背景的同時保留原始图像。' },
  ...
  'background-color': {
    ...
    description: `
      <p>背景颜色允许您更改或添加PDF页面的背景颜色。這可以提高可读性、增加视觉趣味或满足您的品牌要求。</p>
      <p>为背景选择任何颜色并应用到所有页面或选定的页面。该工具在添加背景图层的同時保留所有现有内容。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择文档。' },
    ...
    faq: [
      { question: '背景會覆盖现有内容吗？', answer: '不會，背景添加在现有内容后面，保留所有文本和图像。' },
  ...
  'text-color': {
    ...
    description: `
      <p>更改文本颜色允许您修改PDF文档中文本的颜色。這对于改善对比度、匹配品牌或创建文档的视觉变体非常有用。</p>
      <p>选择新颜色并应用到文档中的所有文本。该工具处理文本元素的同時保留图像和其他内容。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择文档。' },
    ...
    faq: [
      { question: '所有文本都會被更改吗？', answer: '是的，该工具更改文档中所有文本元素的颜色。' },
      { question: '可以只更改特定文本吗？', answer: '此工具更改所有文本。对于选择性更改，请使用编辑PDF工具。' },
      { question: '格式化的文本（粗体、斜体）會保留吗？', answer: '是的，文本格式會保留；只有颜色會更改。' },
    ],
  },
  ...
  'add-stamps': {
    ...
    description: `
      ...
      <p>将印章定位在页面的任何位置，调整大小，并应用到單個或多個页面。非常适合文档工作流程、审批和状态指示。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择文档。' },
    ...
    faq: [
      ...
      { question: '可以在一個文档中添加多個印章吗？', answer: '是的，您可以添加多個印章并独立定位每個印章。' },
    ],
  },
  ...
  'remove-annotations': {
    ...
    description: `
      <p>删除注释可以从PDF文档中去除评论、高亮、便签和其他注释。這将创建一個没有标记的干净文档版本。</p>
    ...
    faq: [
      ...
      { question: '這是可逆的吗？', answer: '不，注释删除是永久的。如果需要，请保留原始文件的备份。' },
    ],
  },

  'form-filler': {
    title: '表單填写',
    metaDescription: '在线填写PDF表單。无需打印即可完成交互式PDF表單。',
    keywords: ['填写pdf表單', 'pdf表單填写器', '完成pdf表單', '交互式pdf'],
    description: `
      <p>表單填写允许您直接在浏览器中完成交互式PDF表單。填写文本字段、勾选复选框、选择选项并添加签名，无需打印文档。</p>
      <p>该工具支持标准PDF表單和XFA表單。您填写的数据可以保存，表單可以扁平化以防止进一步编辑。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的表單数据保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF表單', description: '拖放您的PDF表單或点击选择文件。' },
      { step: 2, title: '填写表單', description: '点击表單字段输入文本、勾选复选框或选择选项。' },
      { step: 3, title: '保存并下载', description: '点击保存保留您的输入并下载已填写的表單。' },
    ],
    useCases: [
      { title: '申请表', description: '完成工作申请、许可申请和注册表單。', icon: 'clipboard' },
      { title: '税务表單', description: '电子填写税务文件和财务表單。', icon: 'file-text' },
      { title: '合同', description: '在签署前用您的信息完成合同表單。', icon: 'file-signature' },
    ],
    faq: [
      { question: '可以保存进度吗？', answer: '是的，您可以保存部分填写的表單并稍后继续。' },
      { question: '什么是表單扁平化？', answer: '扁平化将表單字段转换为静态内容，防止进一步编辑。' },
      { question: '支持XFA表單吗？', answer: '是的，该工具支持标准AcroForms和XFA表單。' },
    ],
  },

  'form-creator': {
    title: '表單创建',
    metaDescription: '创建可填写的PDF表單。添加文本字段、复选框和下拉菜單到文档。',
    keywords: ['创建pdf表單', 'pdf表單创建器', '可填写pdf', '添加表單字段'],
    description: `
      <p>表單创建将静态PDF文档转换为交互式可填写表單。添加文本字段、复选框、單选按钮、下拉菜單等以创建专业表單。</p>
      <p>将表單元素拖放到文档上，配置字段属性，创建可以电子填写的表單。非常适合创建申请表、调查问卷和数据收集表單。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择要转换为表單的文档。' },
      { step: 2, title: '添加表單字段', description: '从工具栏选择字段类型并点击将其放置在文档上。' },
      { step: 3, title: '配置并保存', description: '设置字段属性，然后保存并下载可填写的PDF表單。' },
    ],
    useCases: [
      { title: '申请表', description: '创建可填写的工作申请、會員表單和注册表。', icon: 'user-plus' },
      { title: '调查问卷', description: '构建用于数据收集的交互式调查和问卷。', icon: 'clipboard-list' },
      { title: '订單表', description: '创建带有数量字段和复选框的产品订單表。', icon: 'shopping-cart' },
    ],
    faq: [
      { question: '可以添加哪些字段类型？', answer: '文本字段、复选框、單选按钮、下拉菜單、日期选择器和签名字段。' },
      { question: '可以将字段设为必填吗？', answer: '是的，您可以将字段标记为必填并添加验证规则。' },
      { question: '可以添加計算吗？', answer: '可以为数字字段添加基本計算，如求和和平均值。' },
    ],
  },
  ...
  'remove-blank-pages': {
    ...
    description: `
      <p>删除空白页自动检测并从PDF文档中删除空页。這对于清理扫描文档、删除分隔页或消除意外包含的空白页非常有用。</p>
      <p>该工具使用智能检测来识别真正的空白页，同時保留内容最少的页面。您可以调整灵敏度阈值来控制什么算作"空白"。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择文档。' },
    ...
    faq: [
      ...
      { question: '可以预览哪些页面将被删除吗？', answer: '是的，检测到的空白页在删除前會高亮显示以供审阅。' },
  ...
  'image-to-pdf': {
    ...
    description: `
      ...
      <p>将多個图像合并成一個PDF，按任意顺序排列，并自定义页面大小和方向。非常适合创建照片相册、文档存档或作品集。</p>
    ...
    useCases: [
      { title: '照片集', description: '将来自各种来源的照片合并成一個PDF相册。', icon: 'images' },
    ...
    faq: [
      ...
      { question: '可以混合不同的图像格式吗？', answer: '是的，您可以将不同格式的图像合并成一個PDF。' },
      { question: '图像质量會保留吗？', answer: '是的，除非您选择压缩，否则图像以原始质量嵌入。' },
    ],
  },

  'png-to-pdf': {
    title: 'PNG转PDF',
    metaDescription: '将PNG图像转换为PDF。保留透明度并合并多個PNG文件。',
    keywords: ['png转pdf', '转换png', 'png转换器', '透明图像转pdf'],
    description: `
      <p>PNG转PDF将您的PNG图像转换为PDF文档，同時保留透明度。非常适合图形、标志、截图和具有透明背景的图像。</p>
      <p>将多個PNG文件合并成一個PDF，按任意顺序排列，并自定义页面设置。转换過程保持原始图像的高质量。</p>
      <p>所有转换都在您的浏览器中进行，确保您的图像保持私密。</p>
    `,
    howToUse: [
    ...
    faq: [
      { question: '透明度會保留吗？', answer: 'PNG透明度在PDF输出中會保留。' },
  ...
  'webp-to-pdf': {
    ...
    description: `
      <p>WebP转PDF将现代WebP图像转换为PDF文档。WebP是一种流行的网络图像格式，這個工具使转换這些图像变得简單，便于打印或存档。</p>
      <p>将多個WebP文件合并成一個PDF，并可自定义页面设置。转换過程在创建紧凑PDF文件的同時保留图像质量。</p>
      <p>所有转换都在您的浏览器中进行，确保您的图像保持私密。</p>
    `,
    howToUse: [
    ...
    faq: [
      ...
      { question: '质量會保留吗？', answer: '是的，转换過程保留原始图像质量。' },
  ...
  'svg-to-pdf': {
    ...
    description: `
      <p>SVG转PDF将可缩放矢量图形转换为PDF文档，同時保留其矢量质量。SVG文件在任何尺寸下都保持清晰，這种质量在PDF输出中得以保持。</p>
    ...
    faq: [
      { question: '矢量质量會保留吗？', answer: '是的，SVG矢量质量在PDF输出中完全保留。' },
      { question: '可以转换复杂的SVG吗？', answer: '是的，支持带有渐变、滤镜和效果的复杂SVG。' },
      { question: '嵌入字体怎么办？', answer: 'SVG文件中的嵌入字体在PDF中會保留。' },
    ],
  },
  ...
  'bmp-to-pdf': {
    ...
    description: `
      <p>BMP转PDF将位图图像转换为PDF文档。BMP是Windows环境中常用的传统图像格式，這個工具使将這些文件转换为现代PDF格式变得简單。</p>
      <p>将多個BMP文件合并成一個PDF，并可自定义设置。转换過程在保持图像质量的同時压缩通常较大的BMP文件。</p>
      <p>所有转换都在您的浏览器中进行，确保您的图像保持私密。</p>
    `,
    howToUse: [
    ...
    faq: [
      { question: '文件大小會减小吗？', answer: '是的，BMP文件在转换为PDF時通常會显著压缩。' },
      { question: '质量會保留吗？', answer: '是的，转换過程中图像质量得以保持。' },
  ...
  'heic-to-pdf': {
    title: 'HEIC转PDF',
    metaDescription: '将iPhone HEIC照片转换为PDF。Apple图像格式转换变得简單。',
    keywords: ['heic转pdf', '转换heic', 'iphone照片转pdf', 'apple图像转pdf'],
    description: `
      <p>HEIC转PDF将Apple的高效图像格式照片转换为PDF文档。HEIC是iPhone和iPad上的默认照片格式，這個工具使分享這些照片变得简單。</p>
      <p>将多张HEIC照片合并成一個PDF，非常适合从iPhone照片创建照片相册或文档存档。</p>
      <p>所有转换都在您的浏览器中进行，确保您的照片保持私密。</p>
    `,
    howToUse: [
    ...
    useCases: [
      ...
      { title: '跨平台分享', description: '将HEIC转换为PDF以實現通用兼容性。', icon: 'share-2' },
    ],
    faq: [
      { question: '什么是HEIC格式？', answer: 'HEIC（高效图像容器）是Apple的图像格式，比JPEG提供更好的压缩。' },
      { question: '支持實況照片吗？', answer: '實況照片使用关键帧转换为静态图像。' },
      { question: 'EXIF数据會保留吗？', answer: '照片元数据可以在转换過程中选择性保留或删除。' },
    ],
  },
  ...
  'tiff-to-pdf': {
    ...
    description: `
      ...
      <p>多页TIFF文件自动转换为多页PDF。转换過程保留原始图像的高质量。</p>
      <p>所有转换都在您的浏览器中进行，确保您的文件保持私密。</p>
    `,
    howToUse: [
    ...
    faq: [
      ...
      { question: '质量會保留吗？', answer: '是的，TIFF质量在PDF输出中完全保留。' },
  ...
  'txt-to-pdf': {
    ...
    description: `
      <p>文本转PDF将纯文本文件转换为格式化的PDF文档。自定义字体、大小、边距和页面布局，从简單文本创建专业外观的文档。</p>
    ...
    faq: [
      ...
      { question: '自动换行吗？', answer: '是的，长行會自动换行以适应页面。' },
      { question: '可以保留格式吗？', answer: '原始文本中的空白和缩进會保留。' },
    ],
  },
  ...
  'json-to-pdf': {
    ...
    faq: [
      ...
      { question: '嵌套数据如何处理？', answer: '嵌套对象和数组會正确缩进以提高可读性。' },
      { question: '大型JSON文件怎么办？', answer: '大文件會自动分页到多個页面。' },
    ],
  },
  ...
  'word-to-pdf': {
    ...
    description: `
      <p>Word转PDF将Microsoft Word文档转换为PDF格式，同時保留原始格式、布局和内容结构。</p>
      <p>上传您的DOCX文件，获得适合分享、打印或存档的高质量PDF输出。转换過程保持文本格式、段落样式和基本文档结构。</p>
    ...
    faq: [
      ...
      { question: '图像會保留吗？', answer: '文本内容和基本格式會保留。包含许多图像的复杂布局可能會简化渲染。' },
      { question: '转换安全吗？', answer: '是的，所有处理都在您的浏览器中进行。您的文档永远不會离开您的设备。' },
    ],
  },
  ...
  'excel-to-pdf': {
    ...
    description: `
      <p>Excel转PDF将Microsoft Excel电子表格转换为PDF格式，同時保留表格结构和数据组织。</p>
      <p>上传您的XLSX文件，获得具有正确格式化表格的清晰PDF输出。工作簿中的每個工作表都會成为PDF中的單独部分。</p>
    ...
    faq: [
      { question: '支持多個工作表吗？', answer: '是的，工作簿中的所有工作表都會被转换并包含在PDF中。' },
      { question: '支持.xls格式吗？', answer: '目前仅支持.xlsx格式。请先将.xls文件另存为.xlsx。' },
      { question: '公式會保留吗？', answer: 'PDF显示計算值。公式在PDF格式中不可执行。' },
    ],
  },
  ...
  'pptx-to-pdf': {
    ...
    faq: [
      { question: '动画會保留吗？', answer: 'PDF是静态格式，因此动画和過渡不會保留。每张幻灯片变成静态页面。' },
      { question: '支持.ppt格式吗？', answer: '目前仅支持.pptx格式。请先将.ppt文件转换为.pptx。' },
      { question: '演讲者备注會包含吗？', answer: '目前演讲者备注不會包含在PDF输出中。' },
    ],
  },
  ...
  'xps-to-pdf': {
    ...
    description: `
      <p>XPS转PDF将Microsoft XPS（XML纸规范）文档转换为PDF格式，同時保留原始布局、文本和矢量图形。</p>
    ...
    faq: [
      ...
      { question: '支持多页XPS文件吗？', answer: '是的，XPS文档中的所有页面都會转换到PDF中。' },
    ],
  },
  ...
  'rtf-to-pdf': {
    ...
    description: `
      ...
      <p>上传您的RTF文件，获得干净的PDF输出，同時保留文本内容和基本格式。非常适合将旧文档转换为现代PDF格式。</p>
      <p>所有转换都在您的浏览器本地进行，确保您的文档保持私密和安全。</p>
    `,
    howToUse: [
    ...
    faq: [
      { question: '保留哪些格式？', answer: '包括字体、段落和样式在内的基本文本格式會被转换。复杂的RTF功能可能會被简化。' },
      { question: '可以转换多個RTF文件吗？', answer: '目前一次只能转换一個文件。使用合并PDF来合并多個转换后的文件。' },
  ...
  'epub-to-pdf': {
    ...
    faq: [
      { question: '格式會保留吗？', answer: '是的！此工具使用原生EPUB渲染，以高保真度保留文本格式、图片和布局。' },
  ...
  'mobi-to-pdf': {
    ...
    faq: [
      ...
      { question: '格式會保留吗？', answer: '是的！该工具使用原生MOBI渲染来保留文本、图片和布局。' },
    ],
  },

  'fb2-to-pdf': {
    title: 'FB2转PDF',
    metaDescription: '将FictionBook (FB2)电子书转换为PDF。支持多個文件的高质量渲染。',
    ...
    description: `
      ...
      <p>此工具支持.fb2和.fb2.zip文件，并可一次处理多個文件。它保留电子书的文本格式、图片和章节结构。</p>
      <p>所有转换都在您的浏览器本地进行，使用先进的渲染技术，确保您的书籍保持私密，转换速度快。</p>
    `,
    howToUse: [
      { step: 1, title: '上传FB2文件', description: '拖放一個或多個.fb2或.fb2.zip文件，或点击从设备中选择。' },
    ...
    useCases: [
      ...
      { title: '批量转换', description: '一次将多個FB2文件转换为PDF。', icon: 'layers' },
      { title: '通用格式', description: '以适用于任何设备的PDF格式分享电子书。', icon: 'share-2' },
    ],
    faq: [
      { question: '可以一次转换多個FB2文件吗？', answer: '可以！此工具支持同時批量转换最多20個FB2文件。' },
      { question: '支持.fb2.zip文件吗？', answer: '支持，该工具會自动从.fb2.zip压缩包中提取并转换FB2文件。' },
      { question: '格式會保留吗？', answer: '是的！该工具使用原生FB2渲染，以高保真度保留文本格式、图片和章节结构。' },
    ],
  },
  ...
  'pdf-to-jpg': {
    ...
    faq: [
      ...
      { question: '可以只转换特定页面吗？', answer: '是的，您可以选择單個页面或页面范围进行转换。' },
      { question: '多個页面如何处理？', answer: '每個页面成为單独的JPG文件，作为ZIP压缩包下载。' },
    ],
  },
  ...
  'pdf-to-png': {
    ...
    faq: [
      ...
      { question: '支持透明背景吗？', answer: '是的，具有透明度的PDF页面在PNG输出中會保留。' },
  ...
  'pdf-to-webp': {
    ...
    description: `
      <p>PDF转WebP将PDF文档页面转换为WebP图像，這是Google的现代图像格式，提供出色的压缩和高质量。</p>
      <p>WebP图像比JPG或PNG更小，同時保持相当的质量，非常适合网络使用。</p>
      <p>所有转换都在您的浏览器中进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择。' },
  ...
  'pdf-to-tiff': {
    ...
    description: `
      ...
      <p>创建單页TIFF或将所有页面合并成多页TIFF文件。非常适合专业和存档目的。</p>
      <p>所有转换都在您的浏览器中进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择。' },
      { step: 2, title: '配置输出', description: '选择單页或多页TIFF并设置DPI。' },
    ...
    faq: [
      { question: '可以创建多页TIFF吗？', answer: '是的，您可以将所有PDF页面合并成一個多页TIFF。' },
  ...
  'pdf-to-svg': {
    title: 'PDF转SVG',
    metaDescription: '将PDF页面转换为SVG矢量图形。任意尺寸完美缩放，支持單独导出每页。',
    keywords: ['pdf转svg', '转换pdf为svg', '矢量图形', '可缩放pdf', 'svg转换器'],
    description: `
      <p>PDF转SVG将您的PDF文档的每一页转换为可缩放矢量图形（SVG）。SVG是一种矢量格式，在任何缩放级别或打印尺寸下都能保持完美质量。</p>
      <p>与光栅格式（JPG、PNG）不同，SVG图形在缩放時永远不會变得模糊。這使其非常适合标志、图表、技术图纸以及任何需要以不同尺寸显示的内容。</p>
      <p>预览每個转换后的页面，可以單独下载或作为ZIP文件下载。所有处理都在您的浏览器本地进行，确保您的文档完全隐私。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击浏览选择。' },
      { step: 2, title: '配置选项', description: '设置分辨率质量，可选择指定页面范围。' },
      { step: 3, title: '预览和转换', description: '点击转换进行处理。点击缩略图预览每個页面。' },
      { step: 4, title: '下载', description: '下载單個SVG文件或将所有页面打包为ZIP压缩包。' },
    ],
    useCases: [
    ...
    faq: [
      ...
      { question: '可以在下载前预览吗？', answer: '可以！点击任何缩略图查看SVG的完整尺寸预览。您可以下载單個页面或全部下载。' },
      { question: '应该选择什么分辨率？', answer: '更高的分辨率（216或288 DPI）會产生更大、更详细的SVG。使用较低设置可以加快处理速度并获得更小的文件。' },
    ],
  },
  ...
  'pdf-to-greyscale': {
    ...
    description: `
      <p>PDF转灰度将彩色PDF文档转换为灰度（黑白）。這可以减小文件大小并为黑白打印准备文档。</p>
      <p>转换過程在删除颜色信息的同時保留文本清晰度和图像细节。非常适合草稿打印或创建打印机友好版本。</p>
      <p>所有转换都在您的浏览器中进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
    ...
    useCases: [
      ...
      { title: '减小文件大小', description: '通過删除颜色信息减小PDF大小。', icon: 'minimize-2' },
    ],
    faq: [
      { question: '文本會保持可读吗？', answer: '是的，灰度转换過程中文本清晰度得以保留。' },
      { question: '文件會小多少？', answer: '文件大小减少因情况而异，但对于颜色密集的文档可以减少20-50%。' },
  ...
  'pdf-to-json': {
    ...
    useCases: [
      ...
      { title: '集成', description: '通過JSON将PDF内容导入应用程序。', icon: 'plug' },
    ],
    faq: [
  ...
  'pdf-to-pptx': {
    ...
    description: `
      <p>PDF转PowerPoint将您的PDF文档转换为可编辑的PowerPoint演示文稿(PPTX)。每個PDF页面都會转换为保持完美视觉布局的高质量幻灯片。</p>
    ...
    useCases: [
      { title: '创建演示', description: '将PDF文档转换为會议幻灯片。', icon: 'presentation' },
    ...
    faq: [
      ...
      { question: '支持多页吗？', answer: '是的，每一页都會成为一张單独的幻灯片。' },
    ],
  },
  ...
  'pdf-to-excel': {
    ...
    description: `
      ...
      <p>非常适合分析财务报告或数据表。每页的表格提取到單独的Sheet中。</p>
    ...
    useCases: [
      { title: '财务分析', description: '转换银行账單或发票。', icon: 'trending-up' },
      { title: '数据提取', description: '从报告中提取数据表。', icon: 'database' },
      { title: '清單转换', description: '将PDF库存清單转换为表格。', icon: 'clipboard' },
    ],
    faq: [
      { question: '如何处理表格？', answer: '每页的表格提取到对应的Excel工作表中。' },
      { question: '如果没有表格？', answer: '将创建一個提示信息工作表。' },
  ...
  'psd-to-pdf': {
    ...
    description: `
      <p>直接在浏览器中将Adobe Photoshop (PSD)文件转换为PDF格式。此工具处理复杂的PSD文件，并在转换過程中保持高质量的视觉效果。</p>
    ...
    faq: [
      ...
      { question: '图层會保留吗？', answer: '生成的PDF是用于查看的PSD扁平化版本。' },
      { question: '有文件大小限制吗？', answer: '我们支持大文件，但非常大的高分辨率PSD可能需要更长的处理時间。' },
    ],
  },
  ...
  'ocr-pdf': {
    ...
    description: `
      ...
      <p>支持多种语言，确保无论文档语言如何都能准确识别文本。在添加可搜索文本层的同時保留原始布局。</p>
    ...
    faq: [
      ...
      { question: '原始布局會保留吗？', answer: '是的，原始视觉布局會保留，并添加可搜索的文本层。' },
      { question: 'OCR有多准确？', answer: '准确性取决于扫描质量，但对于清晰的文档通常超過95%。' },
    ],
  },

  'alternate-merge': {
    title: '交替合并',
    metaDescription: '通過交替页面合并PDF。将正面和背面扫描合并成一個文档。',
    keywords: ['交替合并', '交错pdf', '合并扫描', '正反面合并'],
    description: `
      <p>交替合并通過交替交错两個PDF的页面来合并它们。這非常适合将分别扫描的正面和背面页面合并成一個文档。</p>
      <p>上传两個PDF，工具将通過交替从每個PDF中取一页来合并它们。您還可以反转其中一個文档的顺序以适应从后到前的扫描。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传两個PDF', description: '上传正面页面PDF和背面页面PDF。' },
      { step: 2, title: '配置顺序', description: '选择是否为从后到前的扫描反转第二個文档。' },
      { step: 3, title: '合并并下载', description: '点击合并交错页面并下载。' },
    ],
    useCases: [
      { title: '双面扫描', description: '合并分别扫描的正面和背面页面。', icon: 'copy' },
      { title: '文档组装', description: '交错来自两個相关文档的页面。', icon: 'layers' },
      { title: '书籍扫描', description: '将奇数页和偶数页扫描合并成完整的书籍。', icon: 'book' },
    ],
    faq: [
      { question: '如果文档页数不同怎么办？', answer: '较长文档的额外页面會附加在末尾。' },
      { question: '可以反转页面顺序吗？', answer: '是的，您可以在合并前反转任一文档。' },
      { question: '這与普通合并有什么不同？', answer: '是的，普通合并是追加文档；交替合并是交错页面。' },
    ],
  },
  ...
  'add-attachments': {
    ...
    faq: [
      ...
      { question: '有大小限制吗？', answer: '包括附件在内的PDF总大小不应超過500MB。' },
  ...
  'extract-attachments': {
    ...
    description: `
      <p>提取附件从PDF文档中检索所有嵌入的文件。單独下载附件或作为包含所有文件的ZIP压缩包下载。</p>
    ...
    howToUse: [
      ...
      { step: 3, title: '提取并下载', description: '下载單個文件或全部作为ZIP。' },
    ],
    useCases: [
      { title: '访问源文件', description: '从PDF报告中提取原始数据文件。', icon: 'download' },
      { title: '恢复附件', description: '从PDF包中检索嵌入的文件。', icon: 'folder-open' },
      { title: '批量提取', description: '一次从多個PDF中提取附件。', icon: 'layers' },
    ],
    faq: [
      { question: '如果没有附件怎么办？', answer: '如果没有找到嵌入文件，工具會提示。' },
      { question: '支持所有附件类型吗？', answer: '是的，所有嵌入的文件类型都可以提取。' },
      { question: '可以从多個PDF中提取吗？', answer: '是的，您可以处理多個PDF并下载所有附件。' },
    ],
  },
  ...
  'edit-attachments': {
    ...
    faq: [
      { question: '可以在這里添加新附件吗？', answer: '使用添加附件工具嵌入新文件。' },
  ...
  'divide-pages': {
    title: '分割页面',
    metaDescription: '将PDF页面分割成多個部分。水平或垂直分割页面。',
    keywords: ['分割pdf页面', '拆分页面', '剪切pdf页面', '页面部分'],
    description: `
      <p>分割页面将單個PDF页面分割成多個部分。水平、垂直或网格分割页面，从一页创建多页。</p>
      <p>非常适合分割每页包含多個项目的扫描文档，或将大幅面页面分割成标准尺寸。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择。' },
    ...
    useCases: [
      { title: '分割扫描', description: '分割包含多個文档的扫描页面。', icon: 'scissors' },
    ...
    faq: [
      ...
      { question: '分割线处的内容會怎样？', answer: '内容在分割线处被分割；确保重要内容不在边界处。' },
  ...
  'add-blank-page': {
    ...
    faq: [
      ...
      { question: '可以添加多個空白页吗？', answer: '是的，您可以一次添加任意数量的空白页。' },
  ...
  'reverse-pages': {
    ...
    description: `
      ...
      <p>该工具处理整個文档或选定的页面范围，保持所有内容和格式。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择。' },
    ...
    faq: [
      { question: '书签會更新吗？', answer: '是的，书签會更新以指向正确的反转页面。' },
      { question: '可以只反转部分页面吗？', answer: '是的，您可以选择要反转的页面范围。' },
      { question: '這和旋转一样吗？', answer: '不，反转改变页面顺序；旋转改变页面方向。' },
    ],
  },
  ...
  'rotate-pdf': {
    ...
    description: `
      ...
      <p>统一旋转所有页面或选择特定页面單独旋转。该工具保留所有内容和格式。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择。' },
    ...
    faq: [
      ...
      { question: '旋转會影响打印质量吗？', answer: '不會，旋转保留所有内容质量。' },
  ...
  'n-up-pdf': {
    title: 'N合一PDF',
    metaDescription: '每张纸打印多個PDF页面。创建2合1、4合1或自定义布局。',
    keywords: ['n合一pdf', '每张多页', '2合1打印', '页面拼版'],
    description: `
      <p>N合一PDF将多個页面排列到單张纸上，创建2合1、4合1、6合1、9合1或自定义布局。非常适合打印時节省纸张或创建讲义。</p>
    ...
    faq: [
      ...
      { question: '页面顺序會保留吗？', answer: '是的，页面按阅读顺序排列（从左到右，从上到下）。' },
    ],
  },

  'combine-single-page': {
    title: '合并为單页',
    metaDescription: '将PDF页面拼接成一個连续页面。创建可滚动的單页文档。',
    keywords: ['合并页面', '單页pdf', '拼接页面', '连续滚动'],
    description: `
      <p>合并为單页将所有PDF页面拼接成一個连续页面。创建非常适合网络查看或连续阅读的可滚动文档。</p>
      <p>页面垂直连接，间距可自定义。结果是包含所有内容的單個长页面。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择。' },
      { step: 2, title: '设置间距', description: '选择拼接页面之间的间隙。' },
      { step: 3, title: '合并并下载', description: '点击合并创建單页PDF。' },
    ],
    useCases: [
      { title: '网络文档', description: '创建可滚动的PDF以供网页嵌入。', icon: 'globe' },
      { title: '连续阅读', description: '将分页文档转换为连续滚动。', icon: 'scroll' },
      { title: '长篇内容', description: '合并页面以實現无缝的长篇阅读。', icon: 'file-text' },
    ],
    faq: [
      { question: '有页数限制吗？', answer: '非常长的文档可能受浏览器内存限制。' },
      { question: '可以在页面之间添加分隔符吗？', answer: '是的，您可以在原始页面之间添加间距或线条。' },
      { question: '這适合打印吗？', answer: '结果最适合屏幕查看；打印布局请使用N合一。' },
    ],
  },
  ...
  'view-metadata': {
    ...
    faq: [
      ...
      { question: '可以在這里编辑元数据吗？', answer: '使用编辑元数据工具修改文档属性。' },
      { question: '包含XMP元数据吗？', answer: '是的，标准和XMP元数据都會显示。' },
    ],
  },
  ...
  'edit-metadata': {
    ...
    faq: [
      ...
      { question: '日期可以编辑吗？', answer: '创建和修改日期會自动更新。' },
    ],
  },

  'pdf-to-zip': {
    title: 'PDF转ZIP',
    metaDescription: '将多個PDF打包成ZIP压缩包。压缩和捆绑PDF文件。',
    keywords: ['pdf转zip', '压缩pdf', '捆绑pdf', '存档pdf'],
    description: `
      <p>PDF转ZIP将多個PDF文件打包成一個ZIP压缩包。压缩和捆绑您的PDF以便于共享、存储或备份。</p>
      <p>该工具创建包含所有PDF文件的压缩存档，减少总大小并简化文件管理。</p>
      <p>所有处理都在您的浏览器中进行，确保您的文件保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF', description: '拖放多個PDF文件或点击选择。' },
      { step: 2, title: '配置存档', description: '可选设置存档名称和压缩级别。' },
      { step: 3, title: '创建并下载', description: '点击创建生成ZIP压缩包。' },
    ],
    useCases: [
      { title: '文件共享', description: '捆绑多個PDF以便于共享。', icon: 'share-2' },
      { title: '创建备份', description: '创建PDF集合的压缩备份。', icon: 'archive' },
      { title: '电子邮件附件', description: '将PDF合并成一個附件以供电子邮件使用。', icon: 'mail' },
    ],
    faq: [
      { question: '应用多少压缩？', answer: 'ZIP压缩通常将总大小减少10-30%。' },
      { question: '有文件限制吗？', answer: '您可以在單個存档中包含最多100個PDF。' },
  ...
  'compare-pdfs': {
    title: '比较PDF',
    metaDescription: '比较两個PDF文档。高亮显示版本之间的差异。',
    keywords: ['比较pdf', 'pdf差异', '文档比较', '版本比较'],
    description: `
      <p>比较PDF分析两個PDF文档并高亮显示它们之间的差异。非常适合审阅文档修订、检查合同更改或验证编辑。</p>
      <p>以并排或叠加模式查看文档，差异會高亮显示。该工具识别文本更改、添加和删除。</p>
      <p>所有比较都在您的浏览器中进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传两個PDF', description: '上传原始和修改后的PDF文档。' },
  ...
  'posterize-pdf': {
    ...
    description: `
      ...
      <p>配置网格大小和重叠以便于组装。该工具自动計算目标输出尺寸的瓷砖尺寸。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
    ...
    faq: [
      { question: '应该使用多少重叠？', answer: '建议10-20mm的重叠以便于组装時对齐。' },
  ...
  'fix-page-size': {
    ...
    description: `
      ...
      <p>从标准尺寸（A4、Letter等）中选择或设置自定义尺寸。内容會缩放或定位以适应新的页面大小。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择。' },
  ...
  'linearize-pdf': {
    title: '线性化PDF',
    metaDescription: '优化PDF以實現快速网络查看。启用渐进式加载。',
    keywords: ['线性化pdf', '快速网络查看', '优化pdf', '渐进式pdf'],
    description: `
      <p>线性化PDF优化您的文档以實現快速网络查看。线性化的PDF可以在整個文件下载完成之前开始显示，改善用户体验。</p>
      <p>也称为"快速网络查看"，此优化重新组织PDF结构以實現网络浏览器中的渐进式加载。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择。' },
    ...
    faq: [
      { question: '什么是线性化？', answer: '线性化重新组织PDF数据以實現渐进式加载。' },
      { question: '會减小文件大小吗？', answer: '线性化可能由于添加的结构而略微增加文件大小。' },
  ...
  'page-dimensions': {
    ...
    description: `
      <p>页面尺寸分析并显示PDF文档中每個页面的大小。以各种單位（英寸、毫米、点）查看尺寸并识别非标准大小的页面。</p>
    ...
    faq: [
      { question: '有哪些單位可用？', answer: '英寸、毫米、厘米和点。' },
      { question: '會显示方向吗？', answer: '是的，會指示纵向或横向方向。' },
  ...
  'remove-restrictions': {
    ...
    description: `
      <p>删除限制解锁具有权限限制的PDF，這些限制阻止打印、复制或编辑。此工具在保留文档内容的同時删除所有者密码限制。</p>
    ...
    faq: [
      { question: '這合法吗？', answer: '从您拥有或有权使用的文档中删除限制通常是合法的。' },
      { question: '可以删除打开密码吗？', answer: '不能，对于受密码保护的文档请使用解密PDF。' },
      { question: '内容會受影响吗？', answer: '不會，只删除限制；内容保持不变。' },
    ],
  },
  ...
  'repair-pdf': {
    ...
    faq: [
      ...
      { question: '所有内容都會恢复吗？', answer: '该工具尽可能多地恢复；严重损坏的文件可能有损失。' },
  ...
  'encrypt-pdf': {
    ...
    useCases: [
      ...
      { title: '個人文件', description: '保护個人文档如税务申报表。', icon: 'shield' },
  ...
  'sanitize-pdf': {
    ...
    useCases: [
      ...
      { title: '隐私保护', description: '在共享前删除個人信息。', icon: 'shield' },
      { title: '安全合规', description: '满足文档处理的安全要求。', icon: 'check-circle' },
    ],
    faq: [
      { question: '删除哪些隐藏数据？', answer: '元数据、脚本、附件、评论、表單数据和隐藏图层。' },
      { question: '可见内容會受影响吗？', answer: '不會，只删除隐藏数据；可见内容保持不变。' },
      { question: '這是可逆的吗？', answer: '不，删除的数据无法恢复。保留原件的备份。' },
    ],
  },
  ...
  'decrypt-pdf': {
    ...
    useCases: [
      { title: '删除旧密码', description: '当不再需要密码時解锁文档。', icon: 'unlock' },
    ...
    faq: [
      ...
      { question: '原始文件會被修改吗？', answer: '不會，會创建一個新的不受保护的副本。' },
  ...
  'flatten-pdf': {
    title: '扁平化PDF',
    metaDescription: '扁平化PDF表單和注释。使内容不可编辑。',
    keywords: ['扁平化pdf', '扁平化表單', '扁平化注释', '不可编辑pdf'],
    description: `
      <p>扁平化PDF将表單字段和注释等交互元素转换为静态内容。扁平化的PDF看起来相同，但不能再编辑。</p>
      <p>非常适合完成已填写的表單、保留注释或创建不可编辑的文档版本。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您带有表單或注释的PDF。' },
      { step: 2, title: '选择要扁平化的内容', description: '选择扁平化表單、注释或两者。' },
      { step: 3, title: '扁平化并下载', description: '点击扁平化创建静态PDF。' },
    ],
    useCases: [
      { title: '完成表單', description: '锁定已填写的表單数据以防止更改。', icon: 'lock' },
    ...
    faq: [
      ...
      { question: '外观會改变吗？', answer: '不會，文档看起来相同，但不再是交互式的。' },
      { question: '會减小文件大小吗？', answer: '有時會，因为交互元素被转换为更简單的内容。' },
    ],
  },
  ...
  'remove-metadata-full': {
    ...
    description: `
      <p>删除 PDF 文件中隐藏的所有信息，如作者、创建软件和创建日期/時间。這在从公开发布的材料中清除内部信息時非常重要。</p>
    `,
    howToUse: [
    ...
    useCases: [
      { title: '公共文档分发', description: '在互联网上发布之前删除作者的個人姓名。', icon: 'shield' },
      { title: '企业对企业交易', description: '清除不必要的元数据（如创建历史记录）以保持机密性。', icon: 'briefcase' },
      { title: '匿名材料创建', description: '确保无法通過属性识别身份。', icon: 'user-x' },
    ],
    faq: [
      { question: '文件内容會改变吗？', answer: '不會，任何可见内容（如文本或图像）都不會改变。' },
      { question: '哪些项目會消失？', answer: '标题、作者、主题、关键词、创建日期、修改日期、PDF 创建程序名称等将被删除。' },
  ...
  'remove-metadata': {
    ...
    description: `
      ...
      <p>在共享文档或当元数据可能泄露敏感信息時，对于隐私至关重要。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择。' },
    ...
    faq: [
      ...
      { question: 'XMP元数据會删除吗？', answer: '是的，标准和XMP元数据都會去除。' },
      { question: '内容會受影响吗？', answer: '不會，只删除元数据；文档内容保持不变。' },
    ],
  },
  ...
  'change-permissions': {
    ...
    description: `
      ...
      <p>设置所有者密码以强制执行這些限制。收件人可以查看文档，但在可执行的操作上受到限制。</p>
      <p>所有处理都在您的浏览器本地进行，确保您的文档保持私密。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放您的PDF文件或点击选择。' },
  ...
  'pdf-to-docx': {
    ...
    description: `
      ...
      <p>所有转换均在您的浏览器本地完成，确保您的商业机密和個人隐私不會被泄露。</p>
    `,
    howToUse: [
    ...
    faq: [
      { question: '转换后的排版會乱吗？', answer: '对于标准文档，我们的算法能實現极高的還原度。但如果原PDF是由图片生成的扫描件，建议先使用OCR工具。' },
  ...
  'pdf-to-txt': {
    ...
    description: `
      <p>PDF转文本工具旨在为您提供最纯粹的文字提取体验。它會剥离文档中的背景、图像、链接和复杂的排版，仅保留最核心的文字内容。</p>
    ...
    useCases: [
      { title: '电子书转文本', description: '将PDF格式的小說转换为纯文本，方便在旧款电子书阅读器上使用。', icon: 'book' },
    ...
    faq: [
      ...
      { question: '排版會乱吗？', answer: 'TXT不支持样式，但我们會尽力通過空格和换行保留原始文本的逻辑顺序。' },
  ...
  'pdf-to-pdfa': {
    ...
    description: `
      ...
      <p>该工具會嵌入所有字体并移除不符合存档规范的动态元素（如JavaScript），使文档变得更加稳健和透明。</p>
    `,
    howToUse: [
    ...
    faq: [
      { question: 'PDF/A有什么好处？', answer: '它具有自包含性，這意味着显示文档所需的所有信息（如字体）都已保存在文件内，不依赖外部链接。' },
      { question: '普通PDF查看器能打开吗？', answer: '完全可以。PDF/A与所有现有的PDF阅读器完美兼容。' },
      { question: '转换后文件會变大吗？', answer: '通常會，因为必须嵌入所有字体文件以确保长期显示的准确性。' },
    ],
  },
  ...
  'pdf-to-html': {
    ...
    useCases: [
      { title: '在线展示手册', description: '将产品手册转换为网页，方便客户直接通過手机浏览器查阅。', icon: 'monitor' },
    ...
    faq: [
      ...
      { question: '图片能保留吗？', answer: '可以，PDF中的所有插图和照片都會被优化并保存为网页适用的图像格式。' },
      { question: 'HTML文件里會有乱码吗？', answer: '不會。系统會正确映射编码，确保转换后的文字内容准确无误。' },
    ],
  },

  'extract-images': {
    title: '从PDF提取图片',
    metaDescription: '从PDF文件中提取所有嵌入的图片。支持單独下载或打包成ZIP下载。自动過滤小尺寸图片。',
    keywords: ['提取pdf图片', 'pdf图片提取', '从pdf获取图片', '下载pdf图片', 'pdf转图片'],
    description: `
      <p>从PDF提取图片工具可以从您的PDF文档中检索所有嵌入的图片。您可以單独下载高质量图片，也可以将所有图片打包成ZIP压缩包一次性下载。</p>
      <p>该工具會根据可自定义的尺寸阈值自动過滤掉小图片（如图标和装饰图案）。支持批量处理多個PDF文件，高效便捷。</p>
      <p>所有提取過程都在您的浏览器中进行，确保您的文档保持私密和安全。</p>
    `,
    howToUse: [
      { step: 1, title: '上传PDF文件', description: '拖放一個或多個PDF文件，或点击从设备中选择文件。' },
      { step: 2, title: '设置過滤选项', description: '调整最小宽度、高度和文件大小，過滤掉不需要的小图片。' },
      { step: 3, title: '提取图片', description: '点击提取按钮，查找PDF中所有嵌入的图片。' },
      { step: 4, title: '下载', description: '單独下载每张图片，或将所有图片打包成ZIP压缩包下载。' },
    ],
    useCases: [
    ...
    faq: [
      { question: '提取的图片是什么格式？', answer: '图片會尽可能保持原始格式（JPEG、PNG等）提取，原始像素数据會转换为PNG格式。' },
      { question: '为什么有些图片没有提取出来？', answer: '小于设定尺寸阈值的图片會被過滤掉。调整過滤设置可以提取更小的图片。' },
